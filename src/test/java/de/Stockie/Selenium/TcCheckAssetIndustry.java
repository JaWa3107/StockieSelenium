...
public class TcCheckAssetIndustry {

	WebDriver driver;

  @Test
  @Parameters({"assetName","expectedIndustry"})
  public void start(String assetName, String expectedIndustry ) throws MalformedURLException, InterruptedException {
