...
public class TcCheckAssetSector {

	WebDriver driver;

  @Test
  @Parameters({"assetName","expectedSector"})
  public void start(String assetName, String expectedSector ) throws MalformedURLException, InterruptedException {
